...
const ColumnContextMenu = observer(
  ({ children, columns, onSave }: ColumnContextMenuProps) => {
    return (
      <ContextMenu.Root>
...
const ColumnContextMenuContent = observer(
  ({ columns, onSave }: ColumnContextMenuContentProps) => {
